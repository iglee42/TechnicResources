...
ServerEvents.recipes(e => {
    ...
    function plateGearRodWire(material, base) {
        ...
        if (material !== 'wooden' && material !== 'stone') e.custom({ 'type': 'ad_astra:compressing', 'cookingtime': 800, 'energy': 20, 'ingredient': { 'tag': 'forge:storage_blocks/' + material }, 'result': { 'count': 9, 'id': 'technicresources:' + material + '_plate' } }).id('technicresources:compressing/plates/' + material + '_9')
        if (material !== 'wooden') {
