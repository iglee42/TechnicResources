...
StartupEvents.registry('item', e => {
    ...
    /**************Rods**************/
    registerTag('rods', 'copper_rod', 'Copper Rod').tag('forge:rods').tag('forge:rods/copper').tags('forge:rods/all_metal')
    registerTag('rods', 'diamond_rod', 'Diamond Rod').tag('forge:rods').tag('forge:rods/diamond').tags('forge:rods/all_metal')
    registerTag('rods', 'gold_rod', 'Gold Rod').tag('forge:rods').tag('forge:rods/gold').tags('forge:rods/all_metal')
    registerTag('rods', 'iron_rod', 'Iron Rod').tag('forge:rods').tag('forge:rods/iron').tags('forge:rods/all_metal')
    registerTag('rods', 'netherite_rod', 'Netherite Rod').tag('forge:rods').tag('forge:rods/netherite').tags('forge:rods/all_metal')
    registerTag('rods', 'stone_rod', 'Stone Rod').tag('forge:rods').tag('forge:rods/stone').tags('forge:rods/all_metal')
    registerTag('rods', 'wooden_rod', 'Wooden Rod').tag('forge:rods').tag('forge:rods/wooden').tags('forge:rods/all_metal')
    registerTag('rods', 'compressed_iron_rod', 'Compressed Iron Rod').tag('forge:rods').tag('forge:rods/compressed_iron').tags('forge:rods/all_metal')
    registerTag('rods', 'uraninite_rod', 'Uraninite Rod').tag('forge:rods').tag('forge:rods/uraninite').tags('forge:rods/all_metal')
    registerTag('rods', 'redstone_rod', 'Redstone Rod').tag('forge:rods').tag('forge:rods/redstone').tags('forge:rods/all_metal')
    registerTag('rods', 'emerald_rod', 'Emerald Rod').tag('forge:rods').tag('forge:rods/emerald').tags('forge:rods/all_metal')
    registerTag('rods', 'lapis_lazuli_rod', 'Lapis Lazuli Rod').tag('forge:rods').tag('forge:rods/lapis_lazuli').tags('forge:rods/all_metal')
    registerTag('rods', 'quartz_rod', 'Quartz Rod').tag('forge:rods').tag('forge:rods/quartz').tags('forge:rods/all_metal')
    registerTag('rods', 'amethyst_rod', 'Amethyst Rod').tag('forge:rods').tag('forge:rods/amethyst').tags('forge:rods/all_metal')
    registerTag('rods', 'zinc_rod', 'Zinc Rod').tag('forge:rods').tag('forge:rods/zinc').tags('forge:rods/all_metal')
    registerTag('rods', 'andesite_alloy_rod', 'Andesite Alloy Rod').tag('forge:rods').tag('forge:rods/andesite_alloy').tags('forge:rods/all_metal')
    registerTag('rods', 'brass_rod', 'Brass Rod').tag('forge:rods').tag('forge:rods/brass').tags('forge:rods/all_metal')
    registerTag('rods', 'electrum_rod', 'Electrum Rod').tag('forge:rods').tag('forge:rods/electrum').tags('forge:rods/all_metal')
    registerTag('rods', 'certus_quartz_rod', 'Certus Quartz Rod').tag('forge:rods').tag('forge:rods/certus_quartz').tags('forge:rods/all_metal')
    registerTag('rods', 'fluix_rod', 'Fluix Rod').tag('forge:rods').tag('forge:rods/fluix').tags('forge:rods/all_metal')
    registerTag('rods', 'crystalized_menril_rod', 'Crystallized Menril Rod').tag('forge:rods').tag('forge:rods/crystalized_menril').tags('forge:rods/all_metal')
    registerTag('rods', 'crystalized_chorus_rod', 'Crystallized Chorus Rod').tag('forge:rods').tag('forge:rods/crystalized_chorus').tags('forge:rods/all_metal')
    registerTag('rods', 'desh_rod', 'Desh Rod').tag('forge:rods').tag('forge:rods/desh').tags('forge:rods/all_metal')
    registerTag('rods', 'ostrum_rod', 'Ostrum Rod').tag('forge:rods').tag('forge:rods/ostrum').tags('forge:rods/all_metal')
    registerTag('rods', 'calorite_rod', 'Calorite Rod').tag('forge:rods').tag('forge:rods/calorite').tags('forge:rods/all_metal')
    registerTag('rods', 'bronze_rod', 'Bronze Rod').tag('forge:rods').tag('forge:rods/bronze').tags('forge:rods/all_metal')
    registerTag('rods', 'steel_rod', 'Steel Rod').tag('forge:rods').tag('forge:rods/steel').tags('forge:rods/all_metal')
    registerTag('rods', 'refined_obsidian_rod', 'Refined Obsidian Rod').tag('forge:rods').tag('forge:rods/refined_obsidian').tags('forge:rods/all_metal')
    registerTag('rods', 'refined_glowstone_rod', 'Refined Glowstone Rod').tag('forge:rods').tag('forge:rods/refined_glowstone').tags('forge:rods/all_metal')
    registerTag('rods', 'osmium_rod', 'Osmium Rod').tag('forge:rods').tag('forge:rods/osmium').tags('forge:rods/all_metal')
    registerTag('rods', 'tin_rod', 'Tin Rod').tag('forge:rods').tag('forge:rods/tin').tags('forge:rods/all_metal')
    registerTag('rods', 'lead_rod', 'Lead Rod').tag('forge:rods').tag('forge:rods/lead').tags('forge:rods/all_metal')
    registerTag('rods', 'uranium_rod', 'Uranium Rod').tag('forge:rods').tag('forge:rods/uranium').tags('forge:rods/all_metal')
    registerTag('rods', 'fluorite_rod', 'Fluorite Rod').tag('forge:rods').tag('forge:rods/fluorite').tags('forge:rods/all_metal')
    registerTag('rods', 'black_quartz_rod', 'Black Quartz Rod').tag('forge:rods').tag('forge:rods/black_quartz').tags('forge:rods/all_metal')
    registerTag('rods', 'industrial_iron_rod', 'Industrial Iron Rod').tag('forge:rods').tag('forge:rods/industrial_iron').tags('forge:rods/all_metal')

    /**************Wires**************/
    registerTag('wires', 'copper_wire', 'Copper Wire').tag('forge:wires').tag('forge:wires/copper').tags('forge:wires/all_metal')
    registerTag('wires', 'diamond_wire', 'Diamond Wire').tag('forge:wires').tag('forge:wires/diamond').tags('forge:wires/all_metal')
    registerTag('wires', 'gold_wire', 'Gold Wire').tag('forge:wires').tag('forge:wires/gold').tags('forge:wires/all_metal')
    registerTag('wires', 'iron_wire', 'Iron Wire').tag('forge:wires').tag('forge:wires/iron').tags('forge:wires/all_metal')
    registerTag('wires', 'netherite_wire', 'Netherite Wire').tag('forge:wires').tag('forge:wires/netherite').tags('forge:wires/all_metal')
    registerTag('wires', 'stone_wire', 'Stone Wire').tag('forge:wires').tag('forge:wires/stone').tags('forge:wires/all_metal')
    registerTag('wires', 'wooden_wire', 'Wooden Wire').tag('forge:wires').tag('forge:wires/wooden').tags('forge:wires/all_metal')
    registerTag('wires', 'compressed_iron_wire', 'Compressed Iron Wire').tag('forge:wires').tag('forge:wires/compressed_iron').tags('forge:wires/all_metal')
    registerTag('wires', 'uraninite_wire', 'Uraninite Wire').tag('forge:wires').tag('forge:wires/uraninite').tags('forge:wires/all_metal')
    registerTag('wires', 'redstone_wire', 'Redstone Wire').tag('forge:wires').tag('forge:wires/redstone').tags('forge:wires/all_metal')
    registerTag('wires', 'emerald_wire', 'Emerald Wire').tag('forge:wires').tag('forge:wires/emerald').tags('forge:wires/all_metal')
    registerTag('wires', 'lapis_lazuli_wire', 'Lapis Lazuli Wire').tag('forge:wires').tag('forge:wires/lapis_lazuli').tags('forge:wires/all_metal')
    registerTag('wires', 'quartz_wire', 'Quartz Wire').tag('forge:wires').tag('forge:wires/quartz').tags('forge:wires/all_metal')
    registerTag('wires', 'amethyst_wire', 'Amethyst Wire').tag('forge:wires').tag('forge:wires/amethyst').tags('forge:wires/all_metal')
    registerTag('wires', 'zinc_wire', 'Zinc Wire').tag('forge:wires').tag('forge:wires/zinc').tags('forge:wires/all_metal')
    registerTag('wires', 'andesite_alloy_wire', 'Andesite Alloy Wire').tag('forge:wires').tag('forge:wires/andesite_alloy').tags('forge:wires/all_metal')
    registerTag('wires', 'brass_wire', 'Brass Wire').tag('forge:wires').tag('forge:wires/brass').tags('forge:wires/all_metal')
    registerTag('wires', 'electrum_wire', 'Electrum Wire').tag('forge:wires').tag('forge:wires/electrum').tags('forge:wires/all_metal')
    registerTag('wires', 'certus_quartz_wire', 'Certus Quartz Wire').tag('forge:wires').tag('forge:wires/certus_quartz').tags('forge:wires/all_metal')
    registerTag('wires', 'fluix_wire', 'Fluix Wire').tag('forge:wires').tag('forge:wires/fluix').tags('forge:wires/all_metal')
    registerTag('wires', 'crystalized_menril_wire', 'Crystallized Menril Wire').tag('forge:wires').tag('forge:wires/crystalized_menril').tags('forge:wires/all_metal')
    registerTag('wires', 'crystalized_chorus_wire', 'Crystallized Chorus Wire').tag('forge:wires').tag('forge:wires/crystalized_chorus').tags('forge:wires/all_metal')
    registerTag('wires', 'desh_wire', 'Desh Wire').tag('forge:wires').tag('forge:wires/desh').tags('forge:wires/all_metal')
    registerTag('wires', 'ostrum_wire', 'Ostrum Wire').tag('forge:wires').tag('forge:wires/ostrum').tags('forge:wires/all_metal')
    registerTag('wires', 'calorite_wire', 'Calorite Wire').tag('forge:wires').tag('forge:wires/calorite').tags('forge:wires/all_metal')
    registerTag('wires', 'bronze_wire', 'Bronze Wire').tag('forge:wires').tag('forge:wires/bronze').tags('forge:wires/all_metal')
    registerTag('wires', 'steel_wire', 'Steel Wire').tag('forge:wires').tag('forge:wires/steel').tags('forge:wires/all_metal')
    registerTag('wires', 'refined_obsidian_wire', 'Refined Obsidian Wire').tag('forge:wires').tag('forge:wires/refined_obsidian').tags('forge:wires/all_metal')
    registerTag('wires', 'refined_glowstone_wire', 'Refined Glowstone Wire').tag('forge:wires').tag('forge:wires/refined_glowstone').tags('forge:wires/all_metal')
    registerTag('wires', 'osmium_wire', 'Osmium Wire').tag('forge:wires').tag('forge:wires/osmium').tags('forge:wires/all_metal')
    registerTag('wires', 'tin_wire', 'Tin Wire').tag('forge:wires').tag('forge:wires/tin').tags('forge:wires/all_metal')
    registerTag('wires', 'lead_wire', 'Lead Wire').tag('forge:wires').tag('forge:wires/lead').tags('forge:wires/all_metal')
    registerTag('wires', 'uranium_wire', 'Uranium Wire').tag('forge:wires').tag('forge:wires/uranium').tags('forge:wires/all_metal')
    registerTag('wires', 'fluorite_wire', 'Fluorite Wire').tag('forge:wires').tag('forge:wires/fluorite').tags('forge:wires/all_metal')
    registerTag('wires', 'black_quartz_wire', 'Black Quartz Wire').tag('forge:wires').tag('forge:wires/black_quartz').tags('forge:wires/all_metal')
    registerTag('wires', 'industrial_iron_wire', 'Industrial Iron Wire').tag('forge:wires').tag('forge:wires/industrial_iron').tags('forge:wires/all_metal')
