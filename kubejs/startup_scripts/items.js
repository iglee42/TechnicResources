...
StartupEvents.registry('item', e => {
    ...
    global.materials.forEach((m) => {
        registerTag('gears', m + '_gear', (m.equals('the_ultimate') ? '§c' : '') + ModsUtils.getUpperName(m, '_') + ' Gear').tag('forge:gears/'+m)
    })
    ...
    global.materials.forEach((m) => {
        registerTag('plates', m + '_plate', (m.equals('the_ultimate') ? '§c' : '' )+  ModsUtils.getUpperName(m, '_') + ' Plate').tag('forge:plates/' + m)
    })
...
*/
    /**************Rods**************/
    global.materials.forEach((m) => {
        registerTag('rods', m + '_rod', (m.equals('the_ultimate') ? '§c' : '') + ModsUtils.getUpperName(m, '_') + ' Rod').tag('forge:rods/' + m).tag('forge:rods/all_metal')
    })
    ...
    global.materials.forEach((m) => {
        registerTag('wires', m + '_wire', (m.equals('the_ultimate') ? '§c' : '') + ModsUtils.getUpperName(m, '_') + ' Wire').tag('forge:wires/' + m).tag('forge:wires/all_metal')
    })
    ...
    function registerTag(tag, unlocname, displayname) {
        return e.create('technicresources:' + unlocname).displayName(displayname).texture('technicresources:item/' + tag + '/' + unlocname).tag('forge:' + tag)
    }
